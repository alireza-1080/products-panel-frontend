          ...
          <div className="flex flex-col justify-center rounded-lg p-4">
            <div className="flex flex-wrap items-center justify-center ">
              {cards.map((card, index) => (
                <MinimalCard className="m-2 w-full max-w-[460px] min-w-[280px]" key={index}>
                  <MinimalCardImage className="h-48 sm:h-64 md:h-80" src={card.src} alt={card.title} />
                  <div className="flex flex-col gap-2">
                    <MinimalCardTitle className="text-sm line-clamp-1 sm:text-base md:text-lg lg:text-xl break-words">
                      {card.title}
                    </MinimalCardTitle>
                    <MinimalCardPrice>
                    ...
                    <MinimalCardFooter className="flex gap-2 justify-start">
                      <EditButton />
                      <DeleteButton />
                    </MinimalCardFooter>
                  </div>
